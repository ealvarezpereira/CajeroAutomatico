...
//        obxFrame.add(jLabel1, BorderLayout.NORTH);
    ...
    public void mostrarBotones() {
        ...
        //Creo los botones:
        jBoton1 = new JButton("1");
        jBoton2 = new JButton("2");
        jBoton3 = new JButton("3");
        jBoton4 = new JButton("4");
        jBoton5 = new JButton("5");
        jBoton6 = new JButton("6");
        jBoton7 = new JButton("7");
        jBoton8 = new JButton("8");
        jBoton9 = new JButton("9");
        ...
        this.jBoton1.addActionListener(this);
        this.jBoton2.addActionListener(this);
        this.jBoton3.addActionListener(this);
        this.jBoton4.addActionListener(this);
        this.jBoton5.addActionListener(this);
        this.jBoton6.addActionListener(this);
        this.jBoton7.addActionListener(this);
        this.jBoton8.addActionListener(this);
        this.jBoton9.addActionListener(this);
    }
